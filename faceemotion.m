...
% FACEEMOTION MATLAB code for faceemotion.fig
%      FACEEMOTION, by itself, creates a new FACEEMOTION or raises the existing
%      singleton*.
%
%      H = FACEEMOTION returns the handle to a new FACEEMOTION or the handle to
%      the existing singleton*.
%
%      FACEEMOTION('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FACEEMOTION.M with the given input arguments.
%
%      FACEEMOTION('Property','Value',...) creates a new FACEEMOTION or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before faceemotion_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to faceemotion_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help faceemotion

% Last Modified by GUIDE v2.5 12-Apr-2013 04:22:38
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
faceDetector = vision.CascadeObjectDetector; %Use the viola-jones detection framework to detect the face
